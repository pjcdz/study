...
// Remove the Head import and use metadata export instead
...
export default function Page() {
  ...
  return (
    <div>
      {/* Remove Head component here as it's not compatible with App Router */}
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://pjcdz.sentry.io/issues/?project=4509365248917504">Issues Page</a>.
