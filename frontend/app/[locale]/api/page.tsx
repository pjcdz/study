...
import { KeyRound, ExternalLink, Copy, Check, Info, Loader2 } from "lucide-react"
...
const HeaderLoadingFallback = () => (
  <div className="animate-pulse space-y-3 text-center py-4">
    <div className="h-6 w-1/3 bg-muted rounded-md mx-auto"></div>
    <div className="h-4 w-1/2 bg-muted rounded-md mx-auto"></div>
  </div>
);

const ApiKeyCardLoadingFallback = () => (
  <div className="animate-pulse rounded-lg border p-4">
    <div className="h-6 w-1/4 bg-muted rounded-md mb-2"></div>
    <div className="h-4 w-2/3 bg-muted rounded-md mb-6"></div>
    <div className="h-32 bg-muted/50 rounded-md"></div>
  </div>
);

const InstructionsCardLoadingFallback = () => (
  <div className="animate-pulse rounded-lg border p-4">
    <div className="h-6 w-1/4 bg-muted rounded-md mb-2"></div>
    <div className="h-4 w-2/3 bg-muted rounded-md mb-6"></div>
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      >
        ...
        <Suspense fallback={<ApiKeyCardLoadingFallback />}>
          <motion.div variants={itemVariants}>
            <Card>
              <CardHeader>
        ...
        <Suspense fallback={<InstructionsCardLoadingFallback />}>
          <motion.div variants={itemVariants}>
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
  ...
  return (
    <Suspense fallback={
      <div className="flex flex-col items-center justify-center p-12 min-h-[50vh]">
        ...
        <p className="text-muted-foreground">Cargando configuración de API...</p>
      </div>
    }>
      <ApiPageContent />
    </Suspense>
