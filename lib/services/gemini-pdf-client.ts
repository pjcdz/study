...
class GeminiPdfClient {
  ...
  async processPdf(pdfBuffer: Buffer, apiKey: string, options: ProcessPdfOptions = {}): Promise<ProcessPdfResult> {
    try {
...
// Export as ES module
const geminiPdfClient = new GeminiPdfClient();
export default geminiPdfClient;
